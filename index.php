...
?>
<!DOCTYPE html>
<!-- Coding By Yayady.S ..........github = Yayady1999 -->
<html lang="en">
<head>

  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Download YouTube Video Thumbnail | Yayady</title>
...
<div class="animation-area">
  ...
  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
    <header><b>Thumbnail Downloader </b></header>
    <div class="url-input">
      <span class="title">Paste video url:</span>
      <div class="field">
        <input type="text" placeholder="https://www.youtube.com/the_link_of_video" required>
